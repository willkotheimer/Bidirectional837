...
public class ReversibilityTheories
{
    ...
    [
        [nameof(Governance.Domain.Entities.ClaimHeader.Loop2010BB_NM103_PayerName)],
        [nameof(Governance.Domain.Entities.ClaimHeader.Loop2010BA_NM103_SubscriberLastName)],
        [nameof(Governance.Domain.Entities.ClaimHeader.Loop2010AA_NM109_BillingProviderNpi)],
        [nameof(Governance.Domain.Entities.ClaimHeader.CLM01_ClaimControlNumber)],
        [nameof(Governance.Domain.Entities.ClaimHeader.HI01_2_PrincipalDiagnosisCode)],
    ];
    ...
    public void Differences_names_the_governed_column_that_moved(string columnName)
    {
        ...
        var column = typeof(Governance.Domain.Entities.ClaimHeader).GetProperty(columnName)!;
        column.SetValue(right, columnName == nameof(Governance.Domain.Entities.ClaimHeader.HI01_2_PrincipalDiagnosisCode)
            ? "Z99.9"
            : "CHANGED");
    ...
    public void Differences_notices_a_changed_line_amount()
    {
        ...
        Assert.Contains(differences, difference =>
            difference.Contains(nameof(Governance.Domain.Entities.ClaimLineItem.SV102_LineItemChargeAmount),
