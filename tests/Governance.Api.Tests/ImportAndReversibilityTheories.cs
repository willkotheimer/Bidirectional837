...
///
/// The unit-level round trip lives in Governance.Edi.Tests. What is proven here is the loop a user
...
public class ImportAndReversibilityTheories : IClassFixture<GovernedApiFactory>
{
    ...
    public async Task Uploading_a_single_837_file_creates_the_claim_it_describes()
    {
        ...
        var interchange = new Governance.Edi.Edi837Serializer().Serialize(claim);
    ...
    public async Task Archive_containing_one_bad_file_imports_nothing_at_all()
    {
        ...
        var serializer = new Governance.Edi.Edi837Serializer();
        var archive = new Governance.Edi.ClaimArchive(serializer);
